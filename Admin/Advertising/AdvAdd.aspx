<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdvAdd.aspx.cs" Inherits="LidyCms.Web.Admin.Advertising.AdvAdd" %>
...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="AdvList.aspx">返回列表</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 增加广告位</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">增加广告位</th>
      </tr>
      <tr>
