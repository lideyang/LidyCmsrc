<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdvList.aspx.cs" Inherits="LidyCms.Web.Admin.Advertising.AdvList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function() {
		    ...
		    current_page:<%=page %>,
		    num_edge_entries:2,
		    link_to:"?<%=CombUrlTxt(this.keywords, this.property) %>page=__id__"
           });
        });
