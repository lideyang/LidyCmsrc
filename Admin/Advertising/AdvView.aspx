<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdvView.aspx.cs" Inherits="LidyCms.Web.Admin.Advertising.AdvView" %>
...
<form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td>
            <textarea id="txtCopyUrl" class="textarea" style="width:350px;height:45px;vertical-align:middle;"><script type="text/javascript" src="<%=webset.WebPath%>Tools/Advert_js.ashx?id=<%=model.Id%>"></script></textarea>&nbsp; <input id="btnCopy" type="button" value="复制代码" class="submit" style="vertical-align:middle;" /></td>
      </tr>
    </table>
</form>
</body>
