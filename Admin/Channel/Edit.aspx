<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Edit.aspx.cs" Inherits="LidyCms.Web.Admin.Channel.Edit" %>
       ...
       <tr>
        ...
        <td width="75%">
          <asp:TextBox ID="txtPageUrl" runat="server" CssClass="input required" size="30" 
            maxlength="250" HintTitle="类别管理导航" HintInfo="请填写该类别的导航路径，至少1个字符，小于250个字符。如：/News/List.aspx"></asp:TextBox>
        </td>
       </tr>
       <tr>
