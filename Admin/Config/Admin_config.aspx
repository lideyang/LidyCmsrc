<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Admin_config.aspx.cs" Inherits="LidyCms.Web.Admin.Config.admin_config" %>
...
<tbody>
  <tr>
    ...
    <tr>
    <td  width="25%" align="right">虚拟目录：</td>
    <td  width="75%">
	<asp:TextBox ID="txtWebPath" runat="server" CssClass="input required" size="25" 
            maxlength="20" HintTitle="网站的虚拟目录" 
            HintInfo="请填写网站的虚拟目录名称，如果放在根目录下，输入“/”；如：http://abc.com/web，输入“/web/”，要加“/”开头和结尾，否则系统无法使用。"></asp:TextBox>
    </td>
  </tr>
  <tr>
	...
	<asp:TextBox ID="txtWebManagePath" runat="server" CssClass="input required" size="25" 
            maxlength="20" HintTitle="网站的后台管理目录" 
            HintInfo="默认是Admin，如果你已经更改，请输入你更改过的目录名称，如“WebManger”，如果填写不正确，将可能导注系统无法使用。"></asp:TextBox>
    </td>
  </tr>
  <tr>
...
&nbsp;KB </td>
  ...
  <tr>
    ...
    <tr>
    <td align="right">SQL注入过滤：</td>
    <td>
      <asp:TextBox ID="txtWebKillKeywords" runat="server" CssClass="textarea" 
            style="width:300px;height:45px;" maxlength="255" HintTitle="SQL注入过滤" HintInfo="以“,”号分开，如：IS_SRVROLEMEMBER，设置后对用户提交的数据进行过滤，设置太严格会导致数据不完整。" 
            TextMode="MultiLine"></asp:TextBox>
        </td>
  </tr>
  <tr>
    <td align="right">是否开户伪静态：</td>
    <td>
        <asp:RadioButtonList ID="rblIsUrlRewrite" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
  ...
  <tr>
    ...
    <td>
        <asp:RadioButtonList ID="rblIsCheckFeedback" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            <asp:ListItem Value="1"> 是</asp:ListItem>
            <asp:ListItem Value="0"> 否</asp:ListItem>
        </asp:RadioButtonList>
    </td>
  ...
  <tr>
    ...
    <td>
        <asp:RadioButtonList ID="rblIsCheckComment" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            <asp:ListItem Value="1"> 是</asp:ListItem>
            <asp:ListItem Value="0"> 否</asp:ListItem>
        </asp:RadioButtonList>
    </td>
...
<tbody>
  <tr>
    <th colspan="2" align="left"><strong>分页参数设置</strong></th>
  </tr>
  <tr>
    <td  width="25%" align="right">资讯模块：</td>
    <td  width="75%">
        后台：<asp:TextBox ID="txtNewsPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
        &nbsp;前台：<asp:TextBox ID="txtNewsPageNum_Client" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">图文模块：</td>
    <td>
        后台：<asp:TextBox ID="txtPicturePageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
        &nbsp;前台：<asp:TextBox ID="txtPicturePageNum_Client" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">下载模块：</td>
    <td>
        后台：<asp:TextBox ID="txtDownPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
        &nbsp;前台：<asp:TextBox ID="txtDownPageNum_Client" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">内容模块：</td>
    <td>
        后台：<asp:TextBox ID="txtContentPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">留言管理：</td>
    <td>
        后台：<asp:TextBox ID="txtFeedbackPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
        &nbsp;前台：<asp:TextBox ID="txtFeedbackPageNum_Client" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">链接管理：</td>
    <td>
        后台：<asp:TextBox ID="txtLinkPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">评论管理：</td>
    <td>
        后台：<asp:TextBox ID="txtCommentPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
        &nbsp;前台：<asp:TextBox ID="txtCommentPageNum_Client" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">广告管理：</td>
    <td>
        后台：<asp:TextBox ID="txtAdPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">日志管理：</td>
    <td>
        后台：<asp:TextBox ID="txtLogPageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
  <tr>
    <td align="right">管理员管理：</td>
    <td>
        后台：<asp:TextBox ID="txtManagePageNum" CssClass="input required digits" size="2" runat="server" maxlength="9"></asp:TextBox>&nbsp;条
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    <td  width="25%" align="right">是否生成图文缩略图：</td>
    <td  width="75%">
