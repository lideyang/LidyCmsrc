<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="LidyCms.Web.Admin.News.List" EnableEventValidation="false" %>
    ...
    <div class="spClear"></div>
        <div style="line-height:30px;height:30px;">
            ...
            <div class="left">
                ...
                <span class="btn_bg">
                 <asp:LinkButton ID="lbtnDel" runat="server" OnClientClick="return confirm( '确定要删除这些记录吗？ ');" onclick="lbtnDel_Click" href="javascript:__doPostBack('lbtnDel','')">删 除</asp:LinkButton>
                </span>
            </div>
	</div>
    </form>
