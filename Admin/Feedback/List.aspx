<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="List.aspx.cs" Inherits="LidyCms.Web.Admin.Feedback.List" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation"><b>您当前的位置：首页 &gt; 留言管理 &gt; 留言列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center">
          <%#Eval("ReContent").ToString() == "" ? "未回复" : "已回复"%>
        </td>
        <td align="center"><span><a href="edit.aspx?id=<%#Eval("Id") %>"><%#Eval("ReContent").ToString() == "" ? "回复" : "查看"%></a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
