<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FieldAdd.aspx.cs" Inherits="LidyCms.Web.Admin.Pictures.FieldAdd" %>
...
<body>
    ...
    <div class="navigation">
      <span class="back"><a href="FieldList.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 图文管理 &gt; 增加字段</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">增加扩展字段</th>
      </tr>
      <tr>
