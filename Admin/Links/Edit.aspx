<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Edit.aspx.cs" Inherits="LidyCms.Web.Admin.Links.Edit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            if($("#cbIsImage").attr("checked") == true)
            {
                $(".upordown").show();
            }
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 友情链接 &gt; 编辑链接</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">编辑友情链接</th>
        </tr>
        <tr>
