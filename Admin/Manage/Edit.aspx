<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Edit.aspx.cs" Inherits="LidyCms.Web.Admin.Manage.edit" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
          ...
          <table id="tbList2" width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable" style="margin-top:5px;">
              ...
              <tr>
                ...
                <td>
                    <input name="cbLevel" type="checkbox" value="viewNews" />查看
                    <input name="cbLevel" type="checkbox" value="addNews" />添加
                    <input name="cbLevel" type="checkbox" value="editNews" />修改
                    <input name="cbLevel" type="checkbox" value="delNews" />删除
                </td>
              </tr>
              <tr>
