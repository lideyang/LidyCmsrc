<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="List.aspx.cs" Inherits="LidyCms.Web.Admin.Contents.List" %>
...
<body style="padding:10px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><asp:DropDownList ID="ddlClassId" runat="server" CssClass="select"></asp:DropDownList></td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><%#Eval(" CallIndex")%></td>
